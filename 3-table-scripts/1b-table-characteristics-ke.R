...
# child age category
#----------------------------------------
names(table(is.na(dt$agecat))) # Note 345 missing age values
...
write.csv(table_ke_full, file=paste0(tab_path, "/table-characteristics-ke.txt"), row.names=FALSE)
write.csv(table_ke_full, file=paste0(tab_path, "/table-characteristics-ke.csv"), row.names=FALSE)
